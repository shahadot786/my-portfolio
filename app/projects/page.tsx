...
const projects: Project[] = [
    {
        ...
        technologies: ["GraphQL", "Next.js", "PostgreSQL", "Prisma", "Supabase", "TypeScript"],
    ...
    },
    {
        ...
        technologies: ["Next.js", "Node.js", "Express.js", "React Native", "MongoDB", "Redis", "Nx"],
    ...
    return (
        <div className="container-custom">
            ...
            <p className="text-zinc-400 mb-12 leading-relaxed">
                ...
                hobby, some as a proof of concept and others to solve my own pain points.
                ...
                {featuredProjects.map((project, index) => (
                    <div key={index} className="project-card">
                        <div className="flex items-start justify-between gap-4 mb-3">
                            ...
                            {project.featured && <span className="tag-highlight shrink-0">Featured</span>}
                        </div>
