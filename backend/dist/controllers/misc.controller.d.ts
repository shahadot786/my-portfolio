...
export declare const deleteItem: (Model: mongoose.Model<any>) => (req: Request, res: Response, next: NextFunction) => Promise<void>;
export declare const updateItem: (Model: mongoose.Model<any>) => (req: Request, res: Response, next: NextFunction) => Promise<void>;
