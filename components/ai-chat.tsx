...
const sampleResponses = {
  ...
  'default': 'Thanks for your message! I can help answer questions about my projects, technical experience, or discuss potential collaborations. Try asking about:\n\n• "Tell me about Nagad Pulse"\n• "What\'s your tech stack?"\n• "Show me your GitHub stats"\n• "What are your achievements?"\n• "How can we work together?"\n• "What projects have you built?"\n\nWhat would you like to know?'
};
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      type: 'bot',
      content: 'Hi! I\'m Shahadot\'s AI assistant. I can answer questions about his 35+ projects, 5+ years of experience, GitHub stats, achievements, and how you can work together. What would you like to know?',
      timestamp: new Date()
    }
  ]);
  ...
  const sendMessage = async (content: string) => {
    ...
    for (const [keyword, reply] of Object.entries(sampleResponses)) {
      if (keyword !== 'default' && (
        ...
        (keyword === 'github' && (lowerContent.includes('git') || lowerContent.includes('repository') || lowerContent.includes('repo') || lowerContent.includes('code'))) ||
        (keyword === 'skills' && (lowerContent.includes('skill') || lowerContent.includes('ability') || lowerContent.includes('expertise') || lowerContent.includes('technology'))) ||
        (keyword === 'achievements' && (lowerContent.includes('achievement') || lowerContent.includes('accomplishment') || lowerContent.includes('award') || lowerContent.includes('success'))) ||
        (keyword === 'experience' && (lowerContent.includes('work') || lowerContent.includes('job') || lowerContent.includes('career') || lowerContent.includes('background'))) ||
        (keyword === 'contact' && (lowerContent.includes('hire') || lowerContent.includes('work together') || lowerContent.includes('collaborate') || lowerContent.includes('email') || lowerContent.includes('phone')))
      )) {
        response = reply;
        break;
      }
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-40 p-3 sm:p-4 text-white rounded-full shadow-lg transition-all duration-200"
        style={{ 
          backgroundColor: 'var(--color-primary)',
          boxShadow: isOpen ? '0 0 20px var(--color-primary)40' : '0 4px 12px rgba(0,0,0,0.3)'
        }}
      >
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex items-center space-x-3 p-4 border-b border-gray-200 dark:border-gray-700">
              ...
              <div>
                <h3 className="font-semibold text-white text-sm sm:text-base">Shahadot's AI Assistant</h3>
                ...
                >
                  <div className={`flex items-start space-x-2 max-w-[80%] ${
                    ...
                    <div 
                      ...
                      style={message.type === 'user' ? { backgroundColor: 'var(--color-primary)' } : { backgroundColor: '#374151' }}
                    >
                      {message.type === 'user' ? (
            ...
            <div className="px-3 sm:px-4 pb-2">
              <p className="text-xs text-gray-400">
                🔒 Intelligent AI assistant powered by advanced language models. All conversations are secure and private.
              </p>
            </div>
          </motion.div>
        )}
